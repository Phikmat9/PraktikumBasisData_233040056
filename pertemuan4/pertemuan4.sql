create database TugasPertemuan4
use TugasPertemuan4
...
select tahun_masuk from mahasiswa WHERE tahun_masuk
BETWEEN 2010 AND 2022;

select jurusan, alamat  from mahasiswa where jurusan (teknik informatika)
...
select kode_mata_kuliah from jadwal_mata_kuliah WHERE kode_mata_kuliah
LIKE '101%' ;

SELECT nama_mahasiswa, alamat, tahun_masuk from mahasiswa

SELECT DISTINCT nama_mata_kuliah, dosen_pengajar from jadwal_mata_kuliah
